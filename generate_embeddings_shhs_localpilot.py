...
SPLIT_PATH = Path(r'C:\Projects\aiot\sleepfm-repro\artifacts\splits\shhs_downstream_localpilot_split.json')
...
for file_path in tqdm(file_paths, desc='Embedding SHHS localpilot'):
...
with open(MODEL_DIR / 'shhs_localpilot_embedding_summary.json', 'w', encoding='utf-8') as f:
